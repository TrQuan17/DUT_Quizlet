...
public class MyProfileActivity extends AppCompatActivity {
    ...
    private void disableEditing() {
        ...
        name.setText(DbQuery.myProfileModel.getName());
        email.setText(DbQuery.myProfileModel.getEmail());
        if(DbQuery.myProfileModel.getPhone() != null) {
            phone.setText(DbQuery.myProfileModel.getPhone());
        }
    ...
    private void saveData() {
        ...
        DbQuery.saveProfileData(nameStr, phoneStr, new MyCompeleteListenner() {
            @Override
