...
public class DbQuery {
                ...
                .addOnSuccessListener(new OnSuccessListener<DocumentSnapshot>() {
                    ...
                    public void onSuccess(DocumentSnapshot documentSnapshot) {
                        ...
                        if(documentSnapshot.get("BOOKMARKS") != null) {
                            myProfileModel.setBookmarksCount(documentSnapshot.getLong("BOOKMARKS").intValue());
                        }
    ...
    public static void loadBmIds(MyCompeleteListenner myCompeleteListenner) {
        g_bmIdList.clear();
        ...
        g_firestore.collection("USERS")
                ...
                .addOnSuccessListener(new OnSuccessListener<DocumentSnapshot>() {
                    @Override
                    public void onSuccess(DocumentSnapshot documentSnapshot) {
                        int count = myProfileModel.getBookmarksCount();
        ...
        loadCategories(new MyCompeleteListenner() {
            ...
            public void onSuccess() {
                getUserData(new MyCompeleteListenner() {
                    @Override
                    public void onSuccess() {
                        getUsersCount(new MyCompeleteListenner() {
                            @Override
                            public void onSuccess() {
                                loadBmIds(myCompeleteListenner);
                            }
